...
require('dotenv').config();
const HDWalletProvider = require('@truffle/hdwallet-provider');
const mnemonic = process.env.MNEMONIC;  // Your MetaMask's mnemonic
const sepoliaRPC = process.env.SEPOLIA_RPC_URL;  // RPC URL for Sepolia
...
module.exports = {
  ...
  networks: {
    sepolia: {
      ...
      skipDryRun: true        // Skip dry run before migrations for public networks
    },
